...
// Shaders from external/vulkan-demos/shaders/glsl/raytracingbasic
// glslangValidator -V raygen.rgen -o raygen.rgen.spv
// xxd -i -n vulkan_raytracing_1_raygen_spv raygen.rgen.spv > vulkan_raytracing_1_raygen.rgen.inc
#include "vulkan_raytracing_1_raygen.rgen.inc"
// glslangValidator -V miss.rmiss -o miss.rmiss.spv
// xxd -i -n vulkan_raytracing_1_miss_spv miss.rmiss.spv > vulkan_raytracing_1_miss.rmiss.inc
#include "vulkan_raytracing_1_miss.rmiss.inc"
// glslangValidator -V closesthit.rchit -o closesthit.rchit.spv
// xxd -i -n vulkan_raytracing_1_closesthit_spv closesthit.rchit.spv > vulkan_raytracing_1_closesthit.rchit.inc
...
{
	printf("Minimal ray tracing pipeline test based on raytracingbasic\n");
}
...
static void create_pipeline(const vulkan_setup_t& vulkan, Resources& resources)
{
	resources.shader_stages[0] = acceleration_structures::prepare_shader_stage_create_info(
		vulkan, vulkan_raytracing_1_raygen_spv, vulkan_raytracing_1_raygen_spv_len, VK_SHADER_STAGE_RAYGEN_BIT_KHR);
	resources.shader_stages[1] = acceleration_structures::prepare_shader_stage_create_info(
		vulkan, vulkan_raytracing_1_miss_spv, vulkan_raytracing_1_miss_spv_len, VK_SHADER_STAGE_MISS_BIT_KHR);
	resources.shader_stages[2] = acceleration_structures::prepare_shader_stage_create_info(
		vulkan, vulkan_raytracing_1_closesthit_spv, vulkan_raytracing_1_closesthit_spv_len, VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR);
...
int main(int argc, char** argv)
{
	...
	vulkan_setup_t vulkan = test_init(argc, argv, "vulkan_raytracing_1", reqs);
