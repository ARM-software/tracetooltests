...
public:
    ...
    inline VkMemoryPropertyFlags getMemoryProperty() const { return m_memoryProperty; }
...
public:
    ...
    inline VkFramebufferCreateInfo getCreateInfo() const { return m_createInfo; }
